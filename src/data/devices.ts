...
export const devices: DeviceModel[] = [
  ...
  {
    id: 'hp-elitedesk-g4-tower',
    brand: 'HP',
    model: 'EliteDesk 800 G4 Tower',
    category: 'sobremesas',
    description: 'Torre corporativa con mayor capacidad de expansión interna, usada en puestos con periféricos adicionales.',
    specs: [
      { label: 'CPU', value: 'Intel Core i7-8700' },
      { label: 'RAM', value: '16 GB DDR4' },
      { label: 'Almacenamiento', value: '512 GB SSD + 1 TB HDD' },
      { label: 'Factor de forma', value: 'Tower' },
      { label: 'SO', value: 'Windows 10 Pro' },
    ],
    drivers: hpDrivers,
    ...
    shortcuts: hpShortcuts,
    troubleshooting: [
      { title: 'Disco HDD hace ruido / lento', steps: ['Ejecutar chkdsk /f', 'Comprobar estado SMART', 'Clonar a SSD si el fallo persiste', 'Sustituir disco si hay sectores dañados'] },
    ],
    notes: ['Dispone de bahías adicionales para discos'],
    factoryReset: {
      software: 'Inicio > Configuración > Sistema > Recuperación > Restablecer este PC',
      buttons: 'F11 al arrancar > Troubleshoot > Reset this PC',
    },
  ...
  {
    id: 'hp-prodesk-600-g5-sff',
    brand: 'HP',
    model: 'ProDesk 600 G5 SFF',
    category: 'sobremesas',
    description: 'Sobremesa de gama media SFF con Intel 9ª generación, uso general en administración.',
    specs: [
      { label: 'CPU', value: 'Intel Core i5-9500' },
      { label: 'RAM', value: '8 GB DDR4' },
      { label: 'Almacenamiento', value: '256 GB SSD' },
      { label: 'Factor de forma', value: 'Small Form Factor' },
      { label: 'SO', value: 'Windows 10 Pro' },
  ...
  {
    id: 'fujitsu-esprimo-d556',
    brand: 'Fujitsu-Siemens',
    model: 'Esprimo D556',
    category: 'sobremesas',
    description: 'Sobremesa corporativo de gama media, ampliamente desplegado en puestos administrativos antiguos.',
    specs: [
    ...
    notes: ['Modelo en proceso de baja progresiva del inventario'],
    factoryReset: {
      software: 'Inicio > Configuración > Sistema > Recuperación > Restablecer este PC',
  ...
  {
    id: 'hp-elitedesk-705-g4',
    brand: 'HP',
    model: 'EliteDesk 705 G4 SFF',
    category: 'sobremesas',
    description: 'Sobremesa SFF con procesador AMD Ryzen PRO, alternativa económica de buen rendimiento.',
    specs: [
      { label: 'CPU', value: 'AMD Ryzen 5 PRO 2400G' },
      { label: 'RAM', value: '8 GB DDR4' },
      { label: 'Almacenamiento', value: '256 GB SSD' },
      { label: 'Factor de forma', value: 'Small Form Factor' },
      { label: 'SO', value: 'Windows 10 Pro' },
    ...
    shortcuts: hpShortcuts,
    troubleshooting: [
      { title: 'Vídeo integrado no rinde bien', steps: ['Actualizar driver de gráficos AMD', 'Comprobar asignación de memoria de vídeo en BIOS', 'Reducir efectos visuales de Windows'] },
    ],
    factoryReset: {
      software: 'Inicio > Configuración > Sistema > Recuperación > Restablecer este PC',
      buttons: 'F11 al arrancar > Troubleshoot > Reset this PC',
  ...
  {
    id: 'hp-laserjet-pro-m428',
    brand: 'HP',
    model: 'LaserJet Pro MFP M428fdw',
    category: 'impresoras',
    description: 'Multifunción láser monocromo con escáner, fax y conectividad inalámbrica.',
    specs: [
      { label: 'Tipo', value: 'Láser monocromo multifunción' },
      { label: 'Velocidad', value: '40 ppm' },
      { label: 'Conectividad', value: 'Ethernet, WiFi, USB' },
      { label: 'Escáner', value: 'ADF dúplex 50 hojas' },
      { label: 'Fax', value: 'Sí' },
    ],
    drivers: [
      { name: 'Driver universal PCL6', url: 'https://support.hp.com', os: 'Windows 10/11 64-bit', version: '7.2.0' },
    ...
    manuals: [
      { name: 'Manual de usuario', url: 'https://support.hp.com', type: 'PDF' },
      { name: 'Guía de escaneo en red', url: 'https://support.hp.com', type: 'PDF' },
    ],
    links: hpLinks,
    troubleshooting: [
      { title: 'No escanea a carpeta de red', steps: ['Comprobar credenciales configuradas en el panel', 'Verificar ruta de red y permisos de escritura', 'Reiniciar servicio de escaneo desde el servidor web incorporado'] },
    ],
    printerInfo: {
      ip: '192.168.1.41',
      dhcp: true,
      firmware: '20231220',
      maintenance: ['Sustituir tóner cada ~9000 páginas', 'Limpiar cristal del escáner semanalmente'],
      testPage: 'Panel > Informes > Página de configuración',
      cleaning: ['Limpiar cristal y ADF con paño de microfibra', 'Ejecutar limpieza de fusor desde el panel'],
      consumables: [{ name: 'Cartucho de tóner 59X', code: 'CF259X', yield: '10000 páginas' }],
    },
    factoryReset: {
      software: 'Panel de control > Configuración > Restablecer > Restaurar valores de fábrica',
      buttons: 'Mantener botón de cancelar 20 segundos durante el encendido',
  ...
  },
  {
    ...
    model: 'HL-L8360CDW',
    category: 'impresoras',
    description: 'Impresora láser color de alto rendimiento con dúplex y conectividad de red completa.',
    specs: [
      { label: 'Tipo', value: 'Láser color' },
      { label: 'Velocidad', value: '33 ppm' },
      { label: 'Conectividad', value: 'Ethernet, WiFi, USB' },
      { label: 'Dúplex', value: 'Automático' },
    ],
    drivers: [{ name: 'Driver de impresora', url: 'https://support.brother.com', os: 'Windows 10/11 64-bit', version: '1.5.0' }],
    manuals: [{ name: 'Manual de usuario', url: 'https://support.brother.com', type: 'PDF' }],
    links: [{ name: 'Soporte Brother', url: 'https://support.brother.com' }],
    troubleshooting: [
      { title: 'Colores desalineados', steps: ['Ejecutar calibración de color desde el panel', 'Comprobar niveles de tóner de cada color', 'Limpiar unidad del tambor'] },
    ],
    printerInfo: {
      ip: '192.168.1.43',
      dhcp: true,
      maintenance: ['Sustituir kit de tambor cada ~25000 páginas'],
      testPage: 'Panel > Ajustes > Imprimir informes > Configuración de red',
      cleaning: ['Limpiar correa de transferencia según indicaciones del panel'],
      consumables: [{ name: 'Tóner TN-336 (CMYK)', code: 'TN336', yield: '3500 páginas' }],
    },
    factoryReset: {
      software: 'Panel > Ajustes > Todos los ajustes > Config. inicial > Restablecer',
      buttons: 'Mantener pulsado Cancel durante el encendido',
  ...
  },
  {
    ...
    category: 'impresoras',
    description: 'Multifunción láser monocromo con escáner, fax opcional y dúplex automático.',
    specs: [
      { label: 'Tipo', value: 'Láser monocromo multifunción' },
      { label: 'Velocidad', value: '40 ppm' },
      { label: 'Conectividad', value: 'Ethernet, WiFi, USB' },
    ...
    troubleshooting: [
      { title: 'Escaneo lento a PC', steps: ['Comprobar resolución configurada en el driver', 'Actualizar utilidad MF Scan', 'Usar conexión Ethernet en lugar de WiFi'] },
    ],
    printerInfo: {
      ip: '192.168.1.44',
      dhcp: true,
      maintenance: ['Sustituir cartucho de tóner según indicador'],
      testPage: 'Panel > Ajustes de dispositivo > Imprimir lista de datos de usuario',
      cleaning: ['Limpiar cristal de escáner y ADF regularmente'],
      consumables: [{ name: 'Cartucho 057', code: 'CRG-057', yield: '3100 páginas' }],
    },
    factoryReset: {
      software: 'Panel > Ajustes de dispositivo > Gestión > Restaurar ajustes predeterminados',
      buttons: 'No disponible por botón físico, usar menú del panel',
    },
  },
  {
    id: 'ricoh-im-c3000',
  ...
  {
    id: 'kyocera-taskalfa-4054ci',
    brand: 'Kyocera',
    model: 'TASKalfa 4054ci',
    category: 'impresoras',
    description: 'Multifunción color de gran formato para reprografía departamental de alto volumen.',
    specs: [
      { label: 'Tipo', value: 'Láser color multifunción' },
      { label: 'Velocidad', value: '40 ppm' },
      { label: 'Conectividad', value: 'Ethernet' },
      { label: 'Panel', value: 'Táctil color' },
    ],
    ...
    troubleshooting: [
      { title: 'Error de unidad de imagen', steps: ['Revisar código de error en pantalla', 'Reasentar unidad de imagen (drum)', 'Contactar al proveedor de mantenimiento si el error persiste'] },
    ],
    printerInfo: {
      ip: '192.168.1.46',
      dhcp: false,
      maintenance: ['Contrato de renting con mantenimiento incluido'],
      testPage: 'Panel > Contador/Lista > Imprimir lista de estado',
      cleaning: ['Limpieza de cristal de exposición y ADF diaria'],
      consumables: [{ name: 'Tóner TK-8555 (CMYK)', code: 'TK8555', yield: '25000 páginas' }],
    },
    notes: ['Equipo en renting, avisar al proveedor para grandes averías'],
    factoryReset: {
  ...
  {
    id: 'kyocera-ecosys-p3155dn',
    brand: 'Kyocera',
    model: 'ECOSYS P3155dn',
    category: 'impresoras',
    description: 'Impresora láser monocromo de red compacta y de bajo coste por página.',
    specs: [
      { label: 'Tipo', value: 'Láser monocromo' },
      { label: 'Velocidad', value: '35 ppm' },
      { label: 'Conectividad', value: 'Ethernet, USB' },
      { label: 'Dúplex', value: 'Automático' },
    ],
    drivers: [{ name: 'Driver KX', url: 'https://www.kyoceradocumentsolutions.es', os: 'Windows 10/11 64-bit', version: '9.3' }],
  ...
  },
  {
    ...
    model: 'ZD620',
    category: 'impresoras',
    description: 'Impresora térmica de etiquetas de gama media con mayor velocidad y pantalla LCD.',
    specs: [
      { label: 'Tipo', value: 'Transferencia térmica directa/transferencia' },
      { label: 'Resolución', value: '300 dpi (12 dots/mm)' },
      { label: 'Ancho impresión', value: '104 mm' },
      { label: 'Conectividad', value: 'USB, Ethernet, Bluetooth' },
      { label: 'Pantalla', value: 'LCD monocromo' },
    ],
    drivers: zebraDrivers,
    manuals: [{ name: 'Manual de usuario', url: 'https://www.zebra.com/support', type: 'PDF' }],
    links: zebraLinks,
    ...
    troubleshooting: [
      { title: 'Etiquetas descuadradas', steps: ['Calibrar sensor de brecha desde el menú LCD', 'Comprobar guías laterales del rollo', 'Verificar tipo de sensor configurado (gap/black mark)'] },
    ],
    zebraInfo: zebraInfo({ configLabel: 'Menú LCD > Impresora > Imprimir config. de red/impresora' }),
    printerInfo: zebraPrinterInfo('192.168.1.61'),
    factoryReset: {
      software: 'Zebra Setup Utilities > Manage > Restore Factory Defaults',
      buttons: 'Apagar, mantener Pause + Feed, encender y mantener 5 segundos, soltar',
    },
    notes: ['Impresora de etiquetas de identificación de muestras'],
  },
  {
    id: 'zebra-zt411',
    brand: 'Zebra',
    model: 'ZT411',
    category: 'impresoras',
    description: 'Impresora térmica industrial de sobremesa para etiquetado de alto volumen.',
    specs: [
      { label: 'Tipo', value: 'Transferencia térmica directa/transferencia' },
      { label: 'Resolución', value: '203 dpi' },
      { label: 'Ancho impresión', value: '104 mm' },
      { label: 'Conectividad', value: 'USB, Ethernet, Bluetooth, WiFi' },
      { label: 'Pantalla', value: 'Táctil a color' },
    ],
    drivers: zebraDrivers,
    manuals: [{ name: 'Manual de usuario', url: 'https://www.zebra.com/support', type: 'PDF' }],
    links: zebraLinks,
    ...
    troubleshooting: [
      { title: 'Cabezal reporta error de temperatura', steps: ['Dejar enfriar la impresora 10 minutos', 'Comprobar ventilación de la sala', 'Sustituir cabezal si el error persiste'] },
    ],
    zebraInfo: zebraInfo(),
    printerInfo: zebraPrinterInfo('192.168.1.62', true, 'v84.20.13Z'),
    factoryReset: {
      software: 'Panel táctil > Menú > Restaurar valores de fábrica',
      buttons: 'Apagar, mantener Pause + Feed, encender y mantener 5 segundos, soltar',
    },
    notes: ['Impresora industrial de mayor volumen, ubicada en farmacia'],
  },
  {
    id: 'zebra-gk420t',
    brand: 'Zebra',
  ...
  {
    id: 'hp-laserjet-enterprise-m507',
    brand: 'HP',
    model: 'LaserJet Enterprise M507dn',
    category: 'impresoras',
    description: 'Impresora láser monocromo de nivel empresarial para grandes volúmenes departamentales.',
    specs: [
      { label: 'Tipo', value: 'Láser monocromo' },
      { label: 'Velocidad', value: '45 ppm' },
      { label: 'Conectividad', value: 'Ethernet, USB' },
      { label: 'Ciclo de trabajo', value: 'Hasta 150.000 páginas/mes' },
    ],
    drivers: [{ name: 'Driver universal PCL6', url: 'https://support.hp.com', os: 'Windows 10/11 64-bit', version: '7.2.0' }],
    manuals: [{ name: 'Manual de usuario', url: 'https://support.hp.com', type: 'PDF' }],
    links: hpLinks,
    troubleshooting: [
    ...
    printerInfo: {
      ...
      dhcp: true,
      firmware: '20240301',
      maintenance: ['Sustituir tóner cada ~25000 páginas', 'Kit de mantenimiento cada 200.000 páginas'],
      testPage: 'Panel > Informes > Página de configuración',
      cleaning: ['Limpieza automática de fusor desde el panel'],
      consumables: [{ name: 'Cartucho de tóner 90A', code: 'CF390A', yield: '10000 páginas' }],
    },
    notes: ['Impresora principal del servicio de admisión'],
    factoryReset: {
      software: 'Panel de control > Configuración > Restablecer > Restaurar valores de fábrica',
      buttons: 'Mantener botón de cancelar 20 segundos durante el encendido',
    },
  ...
  },
  {
    ...
    model: 'ZD500',
    category: 'impresoras',
    description: 'Impresora térmica de etiquetas de gama media-alta, modelo legado con pantalla LCD a color.',
    specs: [
      { label: 'Tipo', value: 'Transferencia térmica directa/transferencia' },
    ...
    troubleshooting: [
      { title: 'Pantalla LCD en blanco', steps: ['Comprobar alimentación eléctrica', 'Reiniciar la impresora', 'Contactar soporte Zebra si no enciende la pantalla'] },
    ],
    zebraInfo: zebraInfo(),
    printerInfo: zebraPrinterInfo('192.168.1.63', true, 'v72.19.10Z'),
    factoryReset: {
      software: 'Zebra Setup Utilities > Manage > Restore Factory Defaults',
      buttons: 'Apagar, mantener Pause + Feed, encender y mantener 5 segundos, soltar',
    },
